...
    mainContainer: { 
        flex: 1, 
        // Cor de fundo esticada para 100% da largura
        backgroundColor: "#FFD700" 
    },
    scrollContent: {
        paddingVertical: 20,
        paddingHorizontal: 10,
        // Centraliza os cards de vídeo (que têm largura máxima)
        alignItems: 'center', 
        
        // NOVO: Adiciona a borda grossa e roxa ao redor de todo o conteúdo central
        borderWidth: 8, // Largura da borda
        borderColor: '#C2185B', // Cor roxa escura (combinando com o título)
        borderRadius: 16, // Arredondamento da borda para um design suave
        
        // Garante que a borda só apareça no limite de conteúdo na Web
        maxWidth: CARD_MAX_WIDTH + 40, 
        width: '100%',
        alignSelf: 'center', // Centraliza o bloco do scrollContent
...
    videoCard: {
        width: '100%',
        maxWidth: CARD_MAX_WIDTH, // Limite de 600px para o card
        marginBottom: 25,
