...
            
            {/* Linha do componente Image removida ou modificada para não usar a fonte */}
...
    borderColor: "#303F9F",
  },
  // Estilo de placeholder para simular a imagem, já que ela foi removida.
  placeholderImage: {
    width: "100%",
    height: 160,
    backgroundColor: '#CCCCCC', // Cor cinza para indicar onde a imagem estava
  },
  // O estilo cardImage foi mantido mas o componente Image foi substituído acima
  cardImage: {
    width: "100%",
    height: 160,
    resizeMode: "cover",
